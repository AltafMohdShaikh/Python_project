...
Netflix data analysis using Python, Pandas, and Matplotlib. Solves real-world business case studies through KPI analysis, customer segmentation, and interactive data visualizations.
